...
# -*- coding: utf-8 -*-
"""
Run script for the food web diagram in Python
...
import sys
import argparse
from foodweb_diagram import create_foodweb_diagram

def main():
    """Main function to run the food web diagram with command-line arguments"""
    # Create argument parser
    parser = argparse.ArgumentParser(description='Generate food web diagrams')
    ...
    parser.add_argument('--output-file', type=str, default='../images/Python-diagram.png',
